...
export class LiveAudioEngine extends EventTarget {
  ...
  setParams(rawParams) {
    ...
    n.proc.port.postMessage({
      ...
      phraseLift: p.phraseLift / 100,
      endingSoftness: p.endingSoftness / 100,
      deliveryEnergy: p.deliveryEnergy / 100,
      closeMic: p.closeMic / 100,
      romanticBreath: p.romanticBreath / 100,
